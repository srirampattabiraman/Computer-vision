...
class OneCycleLR_A11:
    ...
    def __init__(self,
        ...
        self.num_epochs = num_epochs * self.num_iterations
        self.steps_fifth_epoch = 5 * self.num_iterations
        ...
        self.num_cycle_steps = int(num_epochs * (1. - annihilation_frac))  # Total number of steps in the cycle
