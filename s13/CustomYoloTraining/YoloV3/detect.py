...
if __name__ == '__main__':
    ...
    parser.add_argument('--names', type=str, default='data/customdata_detect/custom.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='weights/last.pt', help='weights path')
    parser.add_argument('--source', type=str, default='data/customdata_detect/images', help='source')  # input file/folder, 0 for webcam
